...
setTimeout(function(){
  ...
  var noticeUrl = "../page/notice/noticeBox.html";

  noticeBox.load(noticeUrl, function(){
    var noticeJs = '<script src="../js/src/notice_page/notice.js"></script>';
    body.append(noticeJs);
  });
},100)
